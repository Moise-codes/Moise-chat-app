...
export const sendMessage = async (req,res) =>{
    try {
        ...
        // emit message to receiver in real-time (supports multiple tabs)
        ...
        // ✅ send email only if receiver is offline
                ...
                await transporter.sendMail({
                    ...
                    html: `
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                            ...
                            <br/>
                            <a href="http://localhost:5173" style="background: #4F46E5; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">Open Chatty</a>
                            <br/><br/>
